...
public class SteamManager : MonoBehaviour {
	...
	// {
	// 	if (SceneManager.GetActiveScene().buildIndex==0 && s_instance == null)
	// 	{
	// 		GameObject steamManagerGameObject = new GameObject("SteamManager");
	// 		s_instance = steamManagerGameObject.AddComponent<SteamManager>();
	// 	}
	// }
