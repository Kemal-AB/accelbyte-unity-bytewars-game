...
public class BrowseMatchSessionWrapper_Starter
{
    private static Session _session;
    private const string ClassName = "[BrowseMatchSessionWrapper_Starter]";
    ...
    {
        //TODO init and call Accelbyte SDK to get created match sessions
    }
    private static void OnBrowseMatchSessionFinished(Result<PaginatedResponse<SessionV2GameSession>> result)
    {
        //TODO handle browse match session result
    }
